...
(function() {
    ...
    function createPersonalizedCard() {
        ...
        card.innerHTML = \`
          ...
          <div class="sc-kSGOQU khoHKY">
            <div class="sc-dvEHMn iPExuY">
              <img height="32px" width="32px" src="\${userAvatar}" alt="\${userName}" class="sc-eKJbhj bvTcOo" style="object-fit: cover; display: block; background-image: none !important; background: none !important;" onerror="console.error('Failed to load user avatar:', this.src); this.onerror=null; this.src='https://cdn.discordapp.com/embed/avatars/0.png?size=128';">
              <div class="sc-jsTgWu LACJw">
                <div class="sc-elAWhN jQgovu">\${userName}</div>
              </div>
            </div>
            <div class="sc-dvEHMn iPExuY">
              <img height="32px" width="32px" src="\${serverIcon}" alt="\${communityName}" class="sc-eKJbhj bvTcOo" style="object-fit: cover; display: block; background-image: none !important; background: none !important;" onerror="this.onerror=null; this.src='\${fallbackServerIcon}';">
              <div class="sc-jsTgWu LACJw">
                <div class="sc-elAWhN jQgovu">\${communityName}</div>
                <div class="sc-kiPvrU iSxYDW">\${communityId}</div>
              </div>
            </div>
            <div class="sc-dvEHMn iPExuY">
              ...
              <div class="sc-jsTgWu LACJw">
                ...
                <div class="sc-kiPvrU iSxYDW">\${interactionId}</div>
              </div>
            </div>
          </div>
        \`;
